  ...
  (e.n = (n) => {
    ...
    (() => {
      ...
      let L = {
        get(n, t, e) {
          if (n instanceof IDBTransaction) {
            if ("done" === t) return k.get(n);
            if ("objectStoreNames" === t) return n.objectStoreNames || S.get(n);
            if ("store" === t)
        ...
        return "function" == typeof n
          ? (t = n) !== IDBDatabase.prototype.transaction ||
            ...
            ? (
              ...
              ? function (...n) {
                  return t.apply(T(this), n), P(x.get(this));
                }
              : function (...n) {
                  return P(t.apply(T(this), n));
                }
            : function (n, ...e) {
                const r = t.call(T(this), n, ...e);
                return S.set(r, n.sort ? n.sort() : [n]), P(r);
              }
        ...
        return (
          r &&
            a.addEventListener("upgradeneeded", (n) => {
              r(P(a.result), n.oldVersion, n.newVersion, P(a.transaction));
            }),
                  ...
                  switch ((n.prev = n.next)) {
                    ...
                    case 3:
                      return (
                        ...
                        (i = o.put({ id: 1, content: t })),
                        (n.next = 9),
                        i
                      );
                    case 9:
                      (a = n.sent),
                        console.log("🚀 - data saved to the database", a);
                    case 11:
                    case "end":
                      return n.stop();
                  }
      ...
      var R = h(function n() {
        ...
        X = e(402),
        nn = {};
      (nn.styleTagTransform = Q()),
        (nn.setAttributes = V()),
        (nn.insert = Z().bind(null, "head")),
        (nn.domAPI = q()),
        (nn.insertStyleElement = $()),
        G()(X.Z, nn),
        X.Z && X.Z.locals && X.Z.locals;
      var tn,
        en = document.querySelector("#main");
      (en.innerHTML = ""),
        void 0 === new R() &&
