(() => {
  ...
  (s.n = (e) => {
    ...
    (() => {
      var e = s(679).warmStrategyCache,
        t = s(162),
        a = t.CacheFirst,
        n = t.StaleWhileRevalidate,
        r = s(615).registerRoute,
        i = s(819).CacheableResponsePlugin,
        c = s(65).ExpirationPlugin;
      ...
      var o = new a({
        ...
        plugins: [
          new i({ statuses: [0, 200] }),
          new c({ maxAgeSeconds: 2592e3 }),
        ],
      });
